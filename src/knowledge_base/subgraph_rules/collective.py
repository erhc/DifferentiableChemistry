...
def get_collective(layer_name: str, node_embed: str, edge_embed: str, connection: str, param_size: tuple, carbon: str, aliphatic_bond: str, max_depth: int):
    template = []
    ...
    template += [R.get(f"{layer_name}_aliphatic_chain")(V.X, V.Y) <= R.get(f"{layer_name}_aliphatic_chain")(V.X, V.Y, max_depth)]
    template += [R.get(f"{layer_name}_aliphatic_chain")(V.X) <= R.get(f"{layer_name}_aliphatic_chain")(V.X, V.Y)]
    ...
    template += [R.get(f"{layer_name}_collective_pattern")(V.X) <= R.get(f"{layer_name}_aliphatic_chain")(V.X)[param_size]]
