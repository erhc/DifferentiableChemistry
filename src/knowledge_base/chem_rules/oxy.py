...
def get_oxy(
    layer_name: str, param_size: tuple, carbon: str, oxygen: str, hydrogen: str
):
    template = []
    ...
    template += [
        R.get(f"{layer_name}_alcoholic")(V.C)
        <= (
    ...
    template += [
        R.get(f"{layer_name}_ketone")(V.C)
        <= (
    ...
    # TODO: this won't work for datasets with implicit hydrogens
    template += [
        R.get(f"{layer_name}_aldehyde")(V.C)
        <= (
    ...
    template += [
        R.get(f"{layer_name}_acyl_halide")(V.C)
        <= (
    ...
    template += [
        R.get(f"{layer_name}_carboxylic_acid")(V.C)
        <= (
    ...
    template += [
        R.get(f"{layer_name}_carboxylic_acid_anhydride")(V.C1, V.C2)
        <= (
    ...
    template += [
        R.get(f"{layer_name}_ester")(V.X) <= R.get(f"{layer_name}_ester")(V.X, V.Y)
    ]
    template += [
        R.get(f"{layer_name}_ester")(V.R1, V.R2)
        <= (
    ...
    template += [
        R.get(f"{layer_name}_carbonate_ester")(V.X)
        <= R.get(f"{layer_name}_carbonate_ester")(V.X, V.Y)
    ]
    template += [
        R.get(f"{layer_name}_carbonate_ester")(V.R1, V.R2)
        <= (
    ...
    template += [
        R.get(f"{layer_name}_ether")(V.X) <= R.get(f"{layer_name}_ether")(V.X, V.Y)
    ]
    template += [
        R.get(f"{layer_name}_ether")(V.C, V.R)
        <= (
            R.get(carbon)(V.C),
            R.get(oxygen)(V.O),
            R.get(carbon)(V.R),
    ...
    template += [
        ...
        <= R.get(f"{layer_name}_alcoholic")(V.X)[param_size]
    ]
    template += [
        R.get(f"{layer_name}_oxy_groups")(V.X)
        <= R.get(f"{layer_name}_ketone")(V.X)[param_size]
    ]
    template += [
        R.get(f"{layer_name}_oxy_groups")(V.X)
        <= R.get(f"{layer_name}_aldehyde")(V.X)[param_size]
    ]
    template += [
        R.get(f"{layer_name}_oxy_groups")(V.X)
        <= R.get(f"{layer_name}_acyl_halide")(V.X)[param_size]
    ]
    template += [
        R.get(f"{layer_name}_oxy_groups")(V.X)
        <= R.get(f"{layer_name}_carboxylic_acid")(V.X)[param_size]
    ]
    template += [
        R.get(f"{layer_name}_oxy_groups")(V.X)
        <= R.get(f"{layer_name}_carboxylic_acid_anhydride")(V.X, V.Y)[param_size]
    ]
    template += [
        R.get(f"{layer_name}_oxy_groups")(V.X)
        <= R.get(f"{layer_name}_ester")(V.X)[param_size]
    ]
    template += [
        R.get(f"{layer_name}_oxy_groups")(V.X)
        <= R.get(f"{layer_name}_carbonate_ester")(V.X)[param_size]
    ]
    template += [
        R.get(f"{layer_name}_oxy_groups")(V.X)
        <= R.get(f"{layer_name}_ether")(V.X)[param_size]
    ]
