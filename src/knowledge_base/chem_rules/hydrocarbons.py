...
def get_hydrocarbons(layer_name: str, param_size: tuple, carbon: str):
    ...
    template += [
        R.get(f"{layer_name}_benzene_ring")(V.A)
        <= R.get(f"{layer_name}_benzene_ring")(V.A, V.B)
    ]
    template += [
        R.get(f"{layer_name}_benzene_ring")(V.A, V.B)
        <= R.get(f"{layer_name}_benzene_ring")(V.A, V.B, V.C, V.D, V.E, V.F)
    ]
    template += [
        R.get(f"{layer_name}_benzene_ring")(V.A, V.B, V.C, V.D, V.E, V.F)
        <= (
    ...
    template += [
        R.get(f"{layer_name}_alkene_bond")(V.C1, V.C2)
        <= (
            R.get(carbon)(V.C1),
            R.get(carbon)(V.C2),
    ...
    template += [
        R.get(f"{layer_name}_alkyne_bond")(V.C1, V.C2)
        <= (
            R.get(carbon)(V.C1),
            R.get(carbon)(V.C2),
    ...
    template += [
        R.get(f"{layer_name}_hydrocarbon_groups")(V.C1)
        <= R.get(f"{layer_name}_alkene_bond")(V.C1, V.C2)[param_size]
    ]
    template += [
        R.get(f"{layer_name}_hydrocarbon_groups")(V.C1)
        <= R.get(f"{layer_name}_alkyne_bond")(V.C1, V.C2)[param_size]
    ]
    template += [
        R.get(f"{layer_name}_hydrocarbon_groups")(V.A)
        <= R.get(f"{layer_name}_benzene_ring")(V.A)[param_size]
    ]
