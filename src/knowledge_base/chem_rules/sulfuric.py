...
def get_sulfuric(
    ...
    template += [
        R.get(f"{layer_name}_thiocyanate")(V.R)
        <= (
            R.get(carbon)(V.C),
            R.get(sulfur)(V.S),
            R.get(nitrogen)(V.N),
    ...
    template += [
        R.get(f"{layer_name}_isothiocyanate")(V.R)
        <= (
            R.get(carbon)(V.C),
            R.get(sulfur)(V.S),
            R.get(nitrogen)(V.N),
    ...
    template += [
        R.get(f"{layer_name}_sulfide")(V.R1, V.R2)
        <= (
            R.get(carbon)(V.R1),
            R.get(sulfur)(V.S),
            R.get(carbon)(V.R2),
    ...
    template += [
        R.get(f"{layer_name}_disulfide")(V.C1, V.C2)
        <= (
            R.get(carbon)(V.C1),
            R.get(sulfur)(V.S1),
            R.get(sulfur)(V.S2),
    ...
    template += [
        ...
        <= R.get(f"{layer_name}_isothiocyanate")(V.X)[param_size]
    ]
    template += [
        R.get(f"{layer_name}_sulfuric_groups")(V.X)
        <= R.get(f"{layer_name}_thiocyanate")(V.X)[param_size]
    ]
    template += [
        R.get(f"{layer_name}_sulfuric_groups")(V.X)
        <= R.get(f"{layer_name}_thiol")(V.X)[param_size]
    ]
    template += [
        R.get(f"{layer_name}_sulfuric_groups")(V.X)
        <= R.get(f"{layer_name}_sulfide")(V.X, V.Y)[param_size]
    ]
    template += [
        R.get(f"{layer_name}_sulfuric_groups")(V.X)
        <= R.get(f"{layer_name}_disulfide")(V.X, V.Y)[param_size]
    ]
