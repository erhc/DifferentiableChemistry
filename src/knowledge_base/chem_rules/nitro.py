...
def get_nitro(
    ...
    template += [
        R.get(f"{layer_name}_quat_ammonion")(V.N)
        <= (
            R.get(nitrogen)(V.N),
            R.get(carbon)(V.C),
            R.get(f"{layer_name}_amino_group")(V.N, V.R1, V.R2, V.R3),
    ...
    template += [
        R.get(f"{layer_name}_amide")(V.R)
        <= (R.get(f"{layer_name}_amide")(V.R, V.R1, V.R2))
    ]
    template += [
        R.get(f"{layer_name}_amide")(V.R1)
        <= (R.get(f"{layer_name}_amide")(V.R, V.R1, V.R2))
    ]
    ...
    template += [
        R.get(f"{layer_name}_imine")(V.R)
        <= R.get(f"{layer_name}_imine")(V.R, V.R1, V.R2)
    ]
    template += [
        R.get(f"{layer_name}_imine")(V.R1)
        <= R.get(f"{layer_name}_imine")(V.R, V.R1, V.R2)
    ]
    template += [
        R.get(f"{layer_name}_imine")(V.R, V.R1, V.R2)
    ...
    template += [
        R.get(f"{layer_name}_imide")(V.R)
        <= R.get(f"{layer_name}_imide")(V.R, V.R1, V.R2)
    ]
    template += [
        R.get(f"{layer_name}_imide")(V.R1)
        <= R.get(f"{layer_name}_imide")(V.R, V.R1, V.R2)
    ]
    template += [
        R.get(f"{layer_name}_imide")(V.R, V.R1, V.R2)
    ...
    template += [
        R.get(f"{layer_name}_azo")(V.C1, V.C2)
        <= (
            R.get(carbon)(V.C1),
            R.get(nitrogen)(V.N1),
            R.get(nitrogen)(V.N2),
    ...
    template += [
        R.get(f"{layer_name}_cyanate")(V.R)
        <= (
            R.get(carbon)(V.C),
            R.get(nitrogen)(V.N),
            R.get(oxygen)(V.O),
    ...
    template += [
        R.get(f"{layer_name}_isocyanate")(V.R)
        <= (
            R.get(carbon)(V.C),
            R.get(nitrogen)(V.N),
            R.get(oxygen)(V.O),
    ...
    template += [
        R.get(f"{layer_name}_nitro_group")(V.R)
        <= (R.get(f"{layer_name}_nitro_group")(V.R, V.N, V.O1, V.O2))
    ]
    template += [
        R.get(f"{layer_name}_nitro_group")(V.R, V.N, V.O1, V.O2)
        <= (
    ...
    template += [
        R.get(f"{layer_name}_nitro")(V.C)
        <= (R.get(carbon)(V.C), R.get(f"{layer_name}_nitro_group")(V.C))
    ]

    # Defining nitrate group (R-O-N(=O)-O)
    template += [
        R.get(f"{layer_name}_nitrate")(V.R)
        <= (R.get(f"{layer_name}_nitrate")(V.R, V.O, V.N, V.O1, V.O2))
    ]
    template += [
        R.get(f"{layer_name}_nitrate")(V.C, V.O, V.N, V.O1, V.O2)
        <= (
            R.get(carbon)(V.C),
            R.get(oxygen)(V.O),
    ...
    template += [
        R.get(f"{layer_name}_carbamate")(V.R)
        <= R.get(f"{layer_name}_carbamate")(V.R, V.R1, V.R2)
    ]
    template += [
        R.get(f"{layer_name}_carbamate")(V.R1)
        <= R.get(f"{layer_name}_carbamate")(V.R, V.R1, V.R2)
    ]
    template += [
        R.get(f"{layer_name}_carbamate")(V.R, V.R1, V.R2)
    ...
    template += [
        R.get(f"{layer_name}_aziridine")(V.C1)
        <= (
            R.get(carbon)(V.C1),
            R.get(carbon)(V.C1),
            R.get(nitrogen)(V.N),
    ...
    template += [
        ...
        <= R.get(f"{layer_name}_amine")(V.X)[param_size]
    ]
    template += [
        R.get(f"{layer_name}_nitrogen_groups")(V.X)
        <= R.get(f"{layer_name}_quat_ammonion")(V.X)[param_size]
    ]
    template += [
        R.get(f"{layer_name}_nitrogen_groups")(V.X)
        <= R.get(f"{layer_name}_amide")(V.X)[param_size]
    ]
    template += [
        R.get(f"{layer_name}_nitrogen_groups")(V.X)
        <= R.get(f"{layer_name}_imine")(V.X)[param_size]
    ]
    template += [
        R.get(f"{layer_name}_nitrogen_groups")(V.X)
        <= R.get(f"{layer_name}_azide")(V.X)[param_size]
    ]
    template += [
        R.get(f"{layer_name}_nitrogen_groups")(V.X)
        <= R.get(f"{layer_name}_imide")(V.X)[param_size]
    ]
    template += [
        R.get(f"{layer_name}_nitrogen_groups")(V.X)
        <= R.get(f"{layer_name}_azo")(V.X, V.Y)[param_size]
    ]
    template += [
        R.get(f"{layer_name}_nitrogen_groups")(V.X)
        <= R.get(f"{layer_name}_isocyanate")(V.X)[param_size]
    ]
    template += [
        R.get(f"{layer_name}_nitrogen_groups")(V.X)
        <= R.get(f"{layer_name}_cyanate")(V.X)[param_size]
    ]
    template += [
        R.get(f"{layer_name}_nitrogen_groups")(V.X)
        <= R.get(f"{layer_name}_nitro")(V.X)[param_size]
    ]
    template += [
        R.get(f"{layer_name}_nitrogen_groups")(V.X)
        <= R.get(f"{layer_name}_nitrate")(V.X)[param_size]
    ]
    template += [
        R.get(f"{layer_name}_nitrogen_groups")(V.X)
        <= R.get(f"{layer_name}_carbamate")(V.X)[param_size]
    ]
    template += [
        R.get(f"{layer_name}_nitrogen_groups")(V.X)
        <= R.get(f"{layer_name}_aziridine")(V.X)[param_size]
    ]
